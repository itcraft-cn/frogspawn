...
public class PrefetchLoopPoolImpl<T extends Resettable> extends AbstractPrefetchPoolImpl<T> {
     ...
     *
     * @param creator 对象创建器，用于生成新的池对象 | Object creator for generating new pool instances
     * @param size    对象池的固定容量大小 | Fixed capacity size of the object pool
     */
     ...
     *
     * @return 返回通过循环策略获取的下一个可用对象实例 | Next available object instance obtained through round-robin strategy
     */
    @Override
