 ...
 */
public abstract class AbstractCachedObjectsMemoryPool<T extends Resettable> implements ObjectsMemoryPool<T> {
    ...
    AbstractCachedObjectsMemoryPool(ObjectCreator<T> creator, int size) {
        // 容量，是比传入的略大的2的幂次方
